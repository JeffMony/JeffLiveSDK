...
// Created by jeffmony
//
JNIEXPORT void JNICALL Java_com_jeffmony_livesdk_core_ColorHelper_NV21TOYUV420SP
...
JNIEXPORT void JNICALL Java_com_jeffmony_livesdk_core_ColorHelper_YUV420SPTOYUV420P
(JNIEnv * env, jobject thiz, jbyteArray srcarray,jbyteArray dstarray,jint ySize) {
	unsigned char *src = (unsigned char *)(*env)->GetByteArrayElements(env,srcarray, 0);
	unsigned char *dst = (unsigned char*)(*env)->GetByteArrayElements(env,dstarray, 0);
...
JNIEXPORT void JNICALL Java_com_jeffmony_livesdk_core_ColorHelper_NV21TOYUV420P
(JNIEnv * env, jobject thiz, jbyteArray srcarray,jbyteArray dstarray,jint ySize) {
	unsigned char *src = (unsigned char *)(*env)->GetByteArrayElements(env,srcarray, 0);
	unsigned char *dst = (unsigned char*)(*env)->GetByteArrayElements(env,dstarray, 0);
...
JNIEXPORT void JNICALL Java_com_jeffmony_livesdk_core_ColorHelper_NV21TOARGB
...
JNIEXPORT void JNICALL Java_com_jeffmony_livesdk_core_ColorHelper_NV21Transform
...
JNIEXPORT void JNICALL Java_com_jeffmony_livesdk_render_GLESRender_NV21TOYUV
...
JNIEXPORT void JNICALL Java_com_jeffmony_livesdk_core_ColorHelper_FIXGLPIXEL
...
//rendering
JNIEXPORT void JNICALL Java_com_jeffmony_livesdk_render_NativeRender_renderingSurface
