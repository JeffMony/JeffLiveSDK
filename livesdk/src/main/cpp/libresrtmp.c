...
/*
 * Class:     com_jeffmony_livesdk_rtmp_RtmpClient
 * Method:    open
 * Signature: (Ljava/lang/String;)I
 */
 JNIEXPORT jlong JNICALL Java_com_jeffmony_livesdk_rtmp_RtmpClient_open
 ...
 * Signature: ([CI)I
 */
 JNIEXPORT jint JNICALL Java_com_jeffmony_livesdk_rtmp_RtmpClient_read
 ...
 * Signature: ([CI)I
 */
 JNIEXPORT jint JNICALL Java_com_jeffmony_livesdk_rtmp_RtmpClient_write
 ...
 * Signature: ()I
 */
 JNIEXPORT jint JNICALL Java_com_jeffmony_livesdk_rtmp_RtmpClient_close
...
JNIEXPORT jstring JNICALL Java_com_jeffmony_livesdk_rtmp_RtmpClient_getIpAddr
